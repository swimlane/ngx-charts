...
export class Wrapper_SeriesHorizontal {
  ...
  constructor() {
    this._changed = false;
    this._changes = {};
    this.context = new import0.SeriesHorizontal();
...
class View_SeriesHorizontal_Host0 extends import2.AppView<any> {
  _el_0:any;
  ...
  destroyInternal():void {
    ...
    this._SeriesHorizontal_0_3.ngOnDestroy();
  }
...
function SeriesHorizontal_animationState_factory(view:import2.AppView<any>,element:any,currentState:any,nextState:any):import9.AnimationTransition {
  ...
  var totalTime:any = 0;
  var defaultStateStyles:any = SeriesHorizontal_animationState_states['*'];
  var startStateStyles:any = SeriesHorizontal_animationState_states[currentState];
...
export class View_SeriesHorizontal0 extends import2.AppView<import0.SeriesHorizontal> {
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 1)) { return new View_SeriesHorizontal1(this.viewUtils,this,1,this._anchor_1,this._vc_1); }
    return (null as any);
  }
}