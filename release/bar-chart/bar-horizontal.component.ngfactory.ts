...
import * as import0 from '../../../build/bar-chart/bar-horizontal.component';
...
import * as import22 from '../../../build/bar-chart/series-horizontal.component';
...
export class Wrapper_BarHorizontalComponent {
  ...
  context:import0.BarHorizontalComponent;
  ...
  constructor(p0:any,p1:any,p2:any,p3:any) {
    this._changed = false;
    this._changes = {};
    this.context = new import0.BarHorizontalComponent(p0,p1,p2,p3);
...
var renderType_BarHorizontalComponent_Host:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_BarHorizontalComponent_Host0 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.BarHorizontalComponent>;
  _BarHorizontalComponent_0_3:Wrapper_BarHorizontalComponent;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_BarHorizontalComponent_Host0,renderType_BarHorizontalComponent_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'ngx-charts-bar-horizontal',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    this.compView_0 = new View_BarHorizontalComponent0(this.viewUtils,this,0,this._el_0);
    this._BarHorizontalComponent_0_3 = new Wrapper_BarHorizontalComponent(new import9.ElementRef(this._el_0),this.injectorGet(import10.NgZone,this.parentIndex),this.compView_0.ref,this.injectorGet(import11.LocationStrategy,this.parentIndex));
    this.compView_0.create(this._BarHorizontalComponent_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._BarHorizontalComponent_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.BarHorizontalComponent) && (0 === requestNodeIndex))) { return this._BarHorizontalComponent_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._BarHorizontalComponent_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    this.compView_0.internalDetectChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._BarHorizontalComponent_0_3.context.ngAfterViewInit(); } }
  }
  destroyInternal():void {
    this.compView_0.destroy();
    this._BarHorizontalComponent_0_3.ngOnDestroy();
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
    cb(this._el_0,ctx);
  }
}
export const BarHorizontalComponentNgFactory:import8.ComponentFactory<import0.BarHorizontalComponent> = new import8.ComponentFactory<import0.BarHorizontalComponent>('ngx-charts-bar-horizontal',View_BarHorizontalComponent_Host0,import0.BarHorizontalComponent);
const styles_BarHorizontalComponent:any[] = [import12.styles];
class View_BarHorizontalComponent1 extends import2.AppView<any> {
  _el_0:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import15.ViewContainer) {
    super(View_BarHorizontalComponent1,renderType_BarHorizontalComponent,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
...
class View_BarHorizontalComponent2 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import16.YAxisComponent>;
  _YAxisComponent_0_3:import17.Wrapper_YAxisComponent;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import15.ViewContainer) {
    super(View_BarHorizontalComponent2,renderType_BarHorizontalComponent,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
...
var renderType_BarHorizontalComponent:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,styles_BarHorizontalComponent,{});
export class View_BarHorizontalComponent0 extends import2.AppView<import0.BarHorizontalComponent> {
  _text_0:any;
  _el_1:any;
  ...
  _text_8:any;
  _el_9:any;
  compView_9:import2.AppView<import22.SeriesHorizontal>;
  _SeriesHorizontal_9_3:import23.Wrapper_SeriesHorizontal;
  _text_10:any;
  _text_11:any;
  _text_12:any;
  _arr_25:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_BarHorizontalComponent0,renderType_BarHorizontalComponent,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce);
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._el_9 = import3.createRenderElement(this.renderer,this._el_3,':svg:g',new import3.InlineArray2(2,'ngx-charts-series-horizontal',''),(null as any));
    this.compView_9 = new import23.View_SeriesHorizontal0(this.viewUtils,this,9,this._el_9);
    this._SeriesHorizontal_9_3 = new import23.Wrapper_SeriesHorizontal();
    ...
    var disposable_1:Function = import3.subscribeToRenderElement(this,this._el_9,new import3.InlineArray8(6,'select',(null as any),'activate',(null as any),'deactivate',(null as any)),this.eventHandler(this.handleEvent_9));
    this._SeriesHorizontal_9_3.subscribe(this,this.eventHandler(this.handleEvent_9),true,true,true);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import22.SeriesHorizontal) && (9 === requestNodeIndex))) { return this._SeriesHorizontal_9_3.context; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this._SeriesHorizontal_9_3.check_tooltipDisabled(currVal_9_0_5,throwOnChange,false);
    const currVal_9_0_6:any = this.context.gradient;
    this._SeriesHorizontal_9_3.check_gradient(currVal_9_0_6,throwOnChange,false);
    const currVal_9_0_7:any = this.context.activeEntries;
    this._SeriesHorizontal_9_3.check_activeEntries(currVal_9_0_7,throwOnChange,false);
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 5)) { return new View_BarHorizontalComponent1(this.viewUtils,this,5,this._anchor_5,this._vc_5); }
    if ((nodeIndex == 7)) { return new View_BarHorizontalComponent2(this.viewUtils,this,7,this._anchor_7,this._vc_7); }
    return (null as any);
  }
