...
import * as import0 from '../../../build/bar-chart/bar-vertical-normalized.component';
...
class View_BarVerticalNormalizedComponent_Host0 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._BarVerticalNormalizedComponent_0_3 = new Wrapper_BarVerticalNormalizedComponent(new import9.ElementRef(this._el_0),this.injectorGet(import10.NgZone,this.parentIndex),this.compView_0.ref,this.injectorGet(import11.LocationStrategy,this.parentIndex));
...
const styles_BarVerticalNormalizedComponent:any[] = [import12.styles];
var BarVerticalNormalizedComponent_animationState_states:any = {
  '*': {},
  'void': {}
}
;
function BarVerticalNormalizedComponent_animationState_factory(view:import2.AppView<any>,element:any,currentState:any,nextState:any):import13.AnimationTransition {
...
class View_BarVerticalNormalizedComponent3 extends import2.AppView<any> {
  ...
  _text_1:any;
  _el_2:any;
  compView_2:import2.AppView<import24.SeriesVerticalComponent>;
  _SeriesVerticalComponent_2_3:import25.Wrapper_SeriesVerticalComponent;
  _text_3:any;
  /*private*/ _expr_6:any;
  /*private*/ _expr_7:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import21.ViewContainer) {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this.compView_2 = new import25.View_SeriesVerticalComponent0(this.viewUtils,this,2,this._el_2);
    this._SeriesVerticalComponent_2_3 = new import25.Wrapper_SeriesVerticalComponent();
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import24.SeriesVerticalComponent) && (2 === requestNodeIndex))) { return this._SeriesVerticalComponent_2_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this._SeriesVerticalComponent_2_3.check_tooltipDisabled(currVal_2_0_6,throwOnChange,false);
    const currVal_2_0_7:any = this.parentView.context.gradient;
    this._SeriesVerticalComponent_2_3.check_gradient(currVal_2_0_7,throwOnChange,false);
    const currVal_2_0_8:any = this.parentView.context.activeEntries;
    this._SeriesVerticalComponent_2_3.check_activeEntries(currVal_2_0_8,throwOnChange,false);
    const currVal_2_0_9:any = this.context.$implicit.name;
    this._SeriesVerticalComponent_2_3.check_seriesName(currVal_2_0_9,throwOnChange,false);
