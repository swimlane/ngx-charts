...
import * as import0 from '../../../build/bar-chart/bar-vertical-stacked.component';
...
class View_BarVerticalStackedComponent_Host0 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._BarVerticalStackedComponent_0_3 = new Wrapper_BarVerticalStackedComponent(new import9.ElementRef(this._el_0),this.injectorGet(import10.NgZone,this.parentIndex),this.compView_0.ref,this.injectorGet(import11.LocationStrategy,this.parentIndex));
...
const styles_BarVerticalStackedComponent:any[] = [import12.styles];
var BarVerticalStackedComponent_animationState_states:any = {
  '*': {},
  'void': {}
}
;
function BarVerticalStackedComponent_animationState_factory(view:import2.AppView<any>,element:any,currentState:any,nextState:any):import13.AnimationTransition {
