...
export class Wrapper_BarHorizontalStacked {
  /*private*/ _eventHandler:Function;
  context:import0.BarHorizontalStacked;
  ...
  constructor(p0:any,p1:any,p2:any) {
    this._changed = false;
    this._changes = {};
    this.context = new import0.BarHorizontalStacked(p0,p1,p2);
...
var renderType_BarHorizontalStacked_Host:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_BarHorizontalStacked_Host0 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.BarHorizontalStacked>;
  _BarHorizontalStacked_0_3:Wrapper_BarHorizontalStacked;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_BarHorizontalStacked_Host0,renderType_BarHorizontalStacked_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this.compView_0 = new View_BarHorizontalStacked0(this.viewUtils,this,0,this._el_0);
    this._BarHorizontalStacked_0_3 = new Wrapper_BarHorizontalStacked(new import8.ElementRef(this._el_0),this.compView_0.ref,this.injectorGet(import9.NgZone,this.parentIndex));
    this.compView_0.create(this._BarHorizontalStacked_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import7.ComponentRef_<any>(0,this,this._el_0,this._BarHorizontalStacked_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.BarHorizontalStacked) && (0 === requestNodeIndex))) { return this._BarHorizontalStacked_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._BarHorizontalStacked_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    this.compView_0.detectChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._BarHorizontalStacked_0_3.context.ngAfterViewInit(); } }
  }
  destroyInternal():void {
    this.compView_0.destroy();
    this._BarHorizontalStacked_0_3.ngOnDestroy();
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
    cb(this._el_0,ctx);
  }
}
export const BarHorizontalStackedNgFactory:import7.ComponentFactory<import0.BarHorizontalStacked> = new import7.ComponentFactory<import0.BarHorizontalStacked>('bar-horizontal-stacked',View_BarHorizontalStacked_Host0,import0.BarHorizontalStacked);
const styles_BarHorizontalStacked:any[] = ([] as any[]);
var BarHorizontalStacked_animationState_states:any = {
  '*': {},
  void: {}
}
;
function BarHorizontalStacked_animationState_factory(view:import2.AppView<any>,element:any,currentState:any,nextState:any):import10.AnimationTransition {
  ...
  var totalTime:any = 0;
  var defaultStateStyles:any = BarHorizontalStacked_animationState_states['*'];
  var startStateStyles:any = BarHorizontalStacked_animationState_states[currentState];
  if ((startStateStyles == (null as any))) { (startStateStyles = defaultStateStyles); }
  var endStateStyles:any = BarHorizontalStacked_animationState_states[nextState];
...
var renderType_BarHorizontalStacked:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,styles_BarHorizontalStacked,{animationState: BarHorizontalStacked_animationState_factory});
export class View_BarHorizontalStacked0 extends import2.AppView<import0.BarHorizontalStacked> {
  _text_0:any;
  _el_1:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_BarHorizontalStacked0,renderType_BarHorizontalStacked,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckOnce);
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 5)) { return new View_BarHorizontalStacked1(this.viewUtils,this,5,this._anchor_5,this._vc_5); }
    if ((nodeIndex == 7)) { return new View_BarHorizontalStacked2(this.viewUtils,this,7,this._anchor_7,this._vc_7); }
    if ((nodeIndex == 9)) { return new View_BarHorizontalStacked3(this.viewUtils,this,9,this._anchor_9,this._vc_9); }
    return (null as any);
  }
}
class View_BarHorizontalStacked1 extends import2.AppView<any> {
  _el_0:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import16.ViewContainer) {
    super(View_BarHorizontalStacked1,renderType_BarHorizontalStacked,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
...
class View_BarHorizontalStacked2 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import30.YAxis>;
  _YAxis_0_3:import31.Wrapper_YAxis;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import16.ViewContainer) {
    super(View_BarHorizontalStacked2,renderType_BarHorizontalStacked,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
...
class View_BarHorizontalStacked3 extends import2.AppView<any> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  ...
  /*private*/ _expr_7:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import16.ViewContainer) {
    super(View_BarHorizontalStacked3,renderType_BarHorizontalStacked,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
    this._expr_6 = import1.UNINITIALIZED;
    this._expr_7 = import1.UNINITIALIZED;
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
