...
import * as import0 from '../../../build/bar-chart/bar-horizontal-2d.component';
...
class View_BarHorizontal2DComponent_Host0 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._BarHorizontal2DComponent_0_3 = new Wrapper_BarHorizontal2DComponent(new import9.ElementRef(this._el_0),this.injectorGet(import10.NgZone,this.parentIndex),this.compView_0.ref,this.injectorGet(import11.LocationStrategy,this.parentIndex));
...
const styles_BarHorizontal2DComponent:any[] = [import12.styles];
var BarHorizontal2DComponent_animationState_states:any = {
  '*': {},
  'void': {}
}
;
function BarHorizontal2DComponent_animationState_factory(view:import2.AppView<any>,element:any,currentState:any,nextState:any):import13.AnimationTransition {
...
class View_BarHorizontal2DComponent3 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this._SeriesHorizontal_2_3.check_tooltipDisabled(currVal_2_0_5,throwOnChange,false);
