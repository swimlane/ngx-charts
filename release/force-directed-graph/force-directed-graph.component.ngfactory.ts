...
export class View_ForceDirectedGraphComponent0 extends import2.AppView<import0.ForceDirectedGraphComponent> {
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._TooltipService_1_5 = new import14.TooltipService(this.parentView.injectorGet(import17.InjectionService,this.parentIndex));
    ...
    this._NgFor_7_6 = new import16.Wrapper_NgFor(this._vc_7.vcRef,this._TemplateRef_7_5,this.parentView.injectorGet(import19.IterableDiffers,this.parentIndex),this.ref);
    ...
    this._NgFor_12_6 = new import16.Wrapper_NgFor(this._vc_12.vcRef,this._TemplateRef_12_5,this.parentView.injectorGet(import19.IterableDiffers,this.parentIndex),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import14.TooltipService) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 15)))) { return this._TooltipService_1_5; }
...
class View_ForceDirectedGraphComponent5 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._TooltipDirective_0_5 = new import25.Wrapper_TooltipDirective((<View_ForceDirectedGraphComponent0>this.parentView)._TooltipService_1_5,this._vc_0.vcRef,this.renderer,new import10.ElementRef(this._el_0),this.parentView.parentView.injectorGet(import11.NgZone,this.parentView.parentIndex));
    this._text_1 = this.renderer.createText(this._el_0,'\n            ',(null as any));
    this._anchor_2 = this.renderer.createTemplateAnchor(this._el_0,(null as any));
    this._vc_2 = new import12.ViewContainer(2,0,this,this._anchor_2);
    this._TemplateRef_2_5 = new import18.TemplateRef_(this,2,this._anchor_2);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import18.TemplateRef) && (4 === requestNodeIndex))) { return this._TemplateRef_4_5; }
    if (((token === import22.NgIf) && (4 === requestNodeIndex))) { return this._NgIf_4_6.context; }
    if (((token === import26.TooltipDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 5)))) { return this._TooltipDirective_0_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
