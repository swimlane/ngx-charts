...
import * as import0 from '../../../src/area-chart/area-chart.component';
...
export class Wrapper_AreaChart {
  /*private*/ _eventHandler:Function;
  context:import0.AreaChart;
  ...
  constructor(p0:any,p1:any,p2:any) {
    this._changed = false;
    this._changes = {};
    this.context = new import0.AreaChart(p0,p1,p2);
  ...
  check_state(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_4,currValue))) {
      ...
      this._changes['state'] = new import1.SimpleChange(this._expr_4,currValue);
  ...
  check_customColors(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_5,currValue))) {
      ...
      this._changes['customColors'] = new import1.SimpleChange(this._expr_5,currValue);
  ...
  check_autoScale(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_8,currValue))) {
      ...
      this._changes['autoScale'] = new import1.SimpleChange(this._expr_8,currValue);
...
var renderType_AreaChart_Host:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_AreaChart_Host0 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.AreaChart>;
  _AreaChart_0_3:Wrapper_AreaChart;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_AreaChart_Host0,renderType_AreaChart_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'area-chart',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    this.compView_0 = new View_AreaChart0(this.viewUtils,this,0,this._el_0);
    this._AreaChart_0_3 = new Wrapper_AreaChart(new import8.ElementRef(this._el_0),this.compView_0.ref,this.injectorGet(import9.NgZone,this.parentIndex));
    this.compView_0.create(this._AreaChart_0_3.context);
    ...
    return new import7.ComponentRef_<any>(0,this,this._el_0,this._AreaChart_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.AreaChart) && (0 === requestNodeIndex))) { return this._AreaChart_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._AreaChart_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    this.compView_0.detectChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._AreaChart_0_3.context.ngAfterViewInit(); } }
  }
  destroyInternal():void {
    this.compView_0.destroy();
    this._AreaChart_0_3.ngOnDestroy();
  }
  ...
  handleEvent_0(eventName:string,$event:any):boolean {
    ...
    var result:boolean = true;
    result = (this._AreaChart_0_3.handleEvent(eventName,$event) && result);
    return result;
  }
}
export const AreaChartNgFactory:import7.ComponentFactory<import0.AreaChart> = new import7.ComponentFactory<import0.AreaChart>('area-chart',View_AreaChart_Host0,import0.AreaChart);
const styles_AreaChart:any[] = ([] as any[]);
var renderType_AreaChart:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,styles_AreaChart,{});
export class View_AreaChart0 extends import2.AppView<import0.AreaChart> {
  _text_0:any;
  _el_1:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_AreaChart0,renderType_AreaChart,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckOnce);
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 13)) { return new View_AreaChart1(this.viewUtils,this,13,this._anchor_13,this._vc_13); }
    if ((nodeIndex == 15)) { return new View_AreaChart2(this.viewUtils,this,15,this._anchor_15,this._vc_15); }
    if ((nodeIndex == 19)) { return new View_AreaChart3(this.viewUtils,this,19,this._anchor_19,this._vc_19); }
    if ((nodeIndex == 23)) { return new View_AreaChart4(this.viewUtils,this,23,this._anchor_23,this._vc_23); }
    if ((nodeIndex == 27)) { return new View_AreaChart5(this.viewUtils,this,27,this._anchor_27,this._vc_27); }
    return (null as any);
  }
...
class View_AreaChart1 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import24.XAxis>;
  _XAxis_0_3:import25.Wrapper_XAxis;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_AreaChart1,renderType_AreaChart,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
...
class View_AreaChart2 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import26.YAxis>;
  _YAxis_0_3:import27.Wrapper_YAxis;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_AreaChart2,renderType_AreaChart,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
...
class View_AreaChart3 extends import2.AppView<any> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  ...
  _text_3:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_AreaChart3,renderType_AreaChart,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    this._el_0 = import3.createRenderElement(this.renderer,(null as any),':svg:g',import3.EMPTY_INLINE_ARRAY,(null as any));
    this._text_1 = this.renderer.createText(this._el_0,'\n            ',(null as any));
    this._el_2 = import3.createRenderElement(this.renderer,this._el_0,':svg:g',new import3.InlineArray2(2,'areaSeries',''),(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this._AreaSeries_2_3.check_gradient(currVal_2_0_5,throwOnChange,false);
    const currVal_2_0_6:any = this.parentView.context.curve;
    this._AreaSeries_2_3.check_curve(currVal_2_0_6,throwOnChange,false);
...
class View_AreaChart4 extends import2.AppView<any> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  ...
  _text_3:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_AreaChart4,renderType_AreaChart,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    this._el_0 = import3.createRenderElement(this.renderer,(null as any),':svg:g',import3.EMPTY_INLINE_ARRAY,(null as any));
    this._text_1 = this.renderer.createText(this._el_0,'\n            ',(null as any));
    this._el_2 = import3.createRenderElement(this.renderer,this._el_0,':svg:g',new import3.InlineArray2(2,'circleSeries',''),(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_2_0_1:any = this.parentView.context.xScale;
    this._CircleSeries_2_3.check_xScale(currVal_2_0_1,throwOnChange,false);
    const currVal_2_0_2:any = this.parentView.context.yScale;
    this._CircleSeries_2_3.check_yScale(currVal_2_0_2,throwOnChange,false);
    const currVal_2_0_3:any = this.parentView.context.colors(this.context.$implicit.name);
    this._CircleSeries_2_3.check_color(currVal_2_0_3,throwOnChange,false);
    const currVal_2_0_4:any = this.parentView.context.colors(this.context.$implicit.name);
    this._CircleSeries_2_3.check_strokeColor(currVal_2_0_4,throwOnChange,false);
    const currVal_2_0_5:any = this.parentView.context.scaleType;
    this._CircleSeries_2_3.check_scaleType(currVal_2_0_5,throwOnChange,false);
    const currVal_2_0_6:any = this.parentView.context.hoveredVertical;
    this._CircleSeries_2_3.check_visibleValue(currVal_2_0_6,throwOnChange,false);
...
class View_AreaChart5 extends import2.AppView<any> {
  _el_0:any;
  ...
  _arr_10:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_AreaChart5,renderType_AreaChart,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
    this._expr_9 = import1.UNINITIALIZED;
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 2)) { return new View_AreaChart6(this.viewUtils,this,2,this._anchor_2,this._vc_2); }
    return (null as any);
  }
  handleEvent_0(eventName:string,$event:any):boolean {
    this.markPathToRootAsCheckOnce();
...
class View_AreaChart6 extends import2.AppView<any> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  compView_2:import2.AppView<import28.AreaSeries>;
  ...
  _text_3:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_AreaChart6,renderType_AreaChart,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    this._el_0 = import3.createRenderElement(this.renderer,(null as any),':svg:g',import3.EMPTY_INLINE_ARRAY,(null as any));
    this._text_1 = this.renderer.createText(this._el_0,'\n          ',(null as any));
