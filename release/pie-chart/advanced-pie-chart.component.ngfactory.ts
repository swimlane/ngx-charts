...
class View_AdvancedPieChartComponent_Host0 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._AdvancedPieChartComponent_0_3 = new Wrapper_AdvancedPieChartComponent(new import9.ElementRef(this._el_0),this.injectorGet(import10.NgZone,this.parentIndex),this.compView_0.ref,this.injectorGet(import11.LocationStrategy,this.parentIndex));
...
export class View_AdvancedPieChartComponent0 extends import2.AppView<import0.AdvancedPieChartComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_9_0_7:any = this.context.tooltipDisabled;
    this._PieSeriesComponent_9_3.check_tooltipDisabled(currVal_9_0_7,throwOnChange,false);
