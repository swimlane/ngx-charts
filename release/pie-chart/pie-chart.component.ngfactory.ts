...
export class Wrapper_PieChart {
  /*private*/ _eventHandler:Function;
  context:import0.PieChart;
  ...
  constructor(p0:any,p1:any,p2:any) {
    this._changed = false;
    this._changes = {};
    this.context = new import0.PieChart(p0,p1,p2);
...
var renderType_PieChart_Host:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_PieChart_Host0 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.PieChart>;
  _PieChart_0_3:Wrapper_PieChart;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_PieChart_Host0,renderType_PieChart_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this.compView_0 = new View_PieChart0(this.viewUtils,this,0,this._el_0);
    this._PieChart_0_3 = new Wrapper_PieChart(new import8.ElementRef(this._el_0),this.compView_0.ref,this.injectorGet(import9.NgZone,this.parentIndex));
    this.compView_0.create(this._PieChart_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import7.ComponentRef_<any>(0,this,this._el_0,this._PieChart_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.PieChart) && (0 === requestNodeIndex))) { return this._PieChart_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._PieChart_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    this.compView_0.detectChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._PieChart_0_3.context.ngAfterViewInit(); } }
  }
  destroyInternal():void {
    this.compView_0.destroy();
    this._PieChart_0_3.ngOnDestroy();
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
    cb(this._el_0,ctx);
  }
}
export const PieChartNgFactory:import7.ComponentFactory<import0.PieChart> = new import7.ComponentFactory<import0.PieChart>('pie-chart',View_PieChart_Host0,import0.PieChart);
const styles_PieChart:any[] = ([] as any[]);
var renderType_PieChart:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,styles_PieChart,{});
export class View_PieChart0 extends import2.AppView<import0.PieChart> {
  _text_0:any;
  _el_1:any;
  ...
  _text_4:any;
  _el_5:any;
  compView_5:import2.AppView<import14.PieSeries>;
  _PieSeries_5_3:import15.Wrapper_PieSeries;
  _text_6:any;
  _text_7:any;
  _text_8:any;
  _arr_15:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_PieChart0,renderType_PieChart,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import1.ChangeDetectorStatus.CheckOnce);
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this.compView_5 = new import15.View_PieSeries0(this.viewUtils,this,5,this._el_5);
    this._PieSeries_5_3 = new import15.Wrapper_PieSeries();
    this.compView_5.create(this._PieSeries_5_3.context);
    this._text_6 = this.renderer.createText(this._el_3,'\n      ',(null as any));
    this._text_7 = this.renderer.createText((null as any),'\n    ',(null as any));
    this.compView_1.create(this._Chart_1_6.context);
    this._text_8 = this.renderer.createText(parentRenderNode,'\n  ',(null as any));
    var disposable_0:Function = import3.subscribeToRenderElement(this,this._el_5,new import3.InlineArray2(2,'clickHandler',(null as any)),this.eventHandler(this.handleEvent_5));
    this._PieSeries_5_3.subscribe(this,this.eventHandler(this.handleEvent_5),true);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import14.PieSeries) && (5 === requestNodeIndex))) { return this._PieSeries_5_3.context; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this._PieSeries_5_3.check_colors(currVal_5_0_0,throwOnChange,false);
    const currVal_5_0_1:any = this.context.data;
    this._PieSeries_5_3.check_series(currVal_5_0_1,throwOnChange,false);
    const currVal_5_0_2:any = this.context.innerRadius;
    this._PieSeries_5_3.check_innerRadius(currVal_5_0_2,throwOnChange,false);
    const currVal_5_0_3:any = this.context.outerRadius;
    this._PieSeries_5_3.check_outerRadius(currVal_5_0_3,throwOnChange,false);
    const currVal_5_0_4:any = this.context.explodeSlices;
    this._PieSeries_5_3.check_explodeSlices(currVal_5_0_4,throwOnChange,false);
    const currVal_5_0_5:any = this.context.labels;
    this._PieSeries_5_3.check_showLabels(currVal_5_0_5,throwOnChange,false);
    const currVal_5_0_6:any = this.context.gradient;
    this._PieSeries_5_3.check_gradient(currVal_5_0_6,throwOnChange,false);
    if (this._PieSeries_5_3.ngDoCheck(this,this._el_5,throwOnChange)) { this.compView_5.markAsCheckOnce(); }
  ...
  destroyInternal():void {
    ...
    this._PieSeries_5_3.ngOnDestroy();
  }
