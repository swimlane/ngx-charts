...
| markers               | object\[\]         |               | An array of marker lines to be shown behind the chart. Every reference line should be of format {name, value, active, color, group}. Color can be an index of color in markerColors -list or a HTML color-code. marked area is defined using same group in several markers.                                                                                                                           |
| markersColors         | string\[\]         |               | Array of predefined marker colors. Colors are referred using array-index in color-property of marker starting from 0                                                                                                                            |
| showMarkers           | boolean            | false         | show or hide the markers                                                                                                                                                                                                           |
| showMarkerLabels      | boolean            | true          | show or hide the labels (name property) for markers. Labels are shown only if markers are visible.                                                                                                                                                                                                   |
