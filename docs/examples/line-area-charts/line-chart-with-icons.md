...
| icons                 | array              |               | the icons to be displayed in the chart                         
                                              |
...
### Line charts with icons

In order to add icons to a line chart an array of icons has to be passed on to the chart via the icons attribute.

```text
<ngx-charts-line-chart-with-icons
