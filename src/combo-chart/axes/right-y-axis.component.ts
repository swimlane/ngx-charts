...
import { RightYAxisTicksComponent } from './right-y-ticks.component';

@Component({
  selector: 'g[ngx-charts-right-y-axis]',
  template: `
    <svg:g
      [attr.class]="yAxisClassName"
      [attr.transform]="transform">
      <svg:g ngx-charts-right-y-axis-ticks
...
export class RightYAxisComponent implements OnChanges {
