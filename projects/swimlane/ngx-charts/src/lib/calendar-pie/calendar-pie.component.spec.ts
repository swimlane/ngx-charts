...
import { CalendarPieModule } from './calendar-pie.module';
...
describe('<ngx-charts-calendar-pie>', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [TestComponent],
      imports: [NoopAnimationsModule, CalendarPieModule],
